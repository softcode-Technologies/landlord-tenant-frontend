          ...
          <CardContent className="p-6 flex flex-col items-center text-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-green-700 mt-1">
                Tenants see a verified badge on your listings and profile.
              </p>
            </div>
          </CardContent>
        </Card>
        ...
        <div className="rounded-xl border-l-4 border-amber-500 bg-amber-50 p-4 flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-amber-700 mt-0.5">
              Verified landlords receive a trust badge, rank higher in search, and can accept rent payments.
            </p>
          </div>
        </div>
      )}
            ...
            {kycMethod === "nin" && (
              <div className="space-y-1.5">
                ...
                <p className="text-xs text-slate-400 italic">
                  Your number is encrypted and never shared with tenants or third parties.
                </p>
              </div>
            )}
