...
import { LayoutDashboard, DollarSign, BarChart3, MessageCircle, User, ShieldCheck, Building2, Wallet, Calendar, Users } from "lucide-react"

const navItems = [
  { label: "Dashboard", href: "/agent", icon: LayoutDashboard },
  { label: "Properties", href: "/agent/properties", icon: Building2 },
  { label: "My landlords", href: "/agent/landlords", icon: Users },
