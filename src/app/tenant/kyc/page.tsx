...
export default function TenantKycPage() {
  ...
  const kycMutation = useMutation({
    mutationFn: async () => {
      ...
      // Document: upload the file directly. Compress images first; leave PDFs.
  ...
  return (
    <div className="space-y-6 max-w-2xl mx-auto">
        ...
        <Card className="border-green-200 bg-green-50">
          <CardContent className="p-6 flex flex-col items-center text-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-green-700 mt-1">Your account is fully verified</p>
            </div>
          </CardContent>
        </Card>
      )}
      ...
      {kycStatus === "pending" && (
        <div className="rounded-xl bg-blue-50 border border-blue-200 p-4 flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-blue-600 mt-2">We&apos;ll notify you once verified.</p>
          </div>
        </div>
      )}
        ...
        <div className="rounded-xl border-l-4 border-amber-500 bg-amber-50 p-4 flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-amber-700 mt-0.5">
              Complete identity verification to unlock rent payments, tenancy agreements, and full
              platform access.
            </p>
          </div>
        </div>
      ...
      {/* Verification form — shown for none or rejected */}
            ...
            {kycMethod === "nin" && (
              <div className="space-y-1.5">
                ...
                <p className="text-xs text-slate-400 italic">
                  Your number is encrypted and never shared with landlords or third parties.
                </p>
              </div>
            )}

            {/* BVN input — never pre-filled */}
            {kycMethod === "bvn" && (
              <div className="space-y-1.5">
