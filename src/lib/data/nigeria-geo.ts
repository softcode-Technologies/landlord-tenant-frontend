...
export const NIGERIA_GEO_DATA: StateData[] = [
  {
    state: "Abia",
    lgas: [
  ...
  },
  {
    state: "Kebbi",
    lgas: [
      "Aliero", "Argungu", "Arewa Dandi", "Augie", "Bagudo", "Birnin Kebbi", "Bunza",
...
export const NIGERIAN_STATES = NIGERIA_GEO_DATA.map((d) => d.state)
