...
export function RentFeeBreakdown({ rentNaira, className }: RentFeeBreakdownProps) {
  ...
  return (
    <div className={`rounded-xl border border-[#00162E]/15 bg-[#00162E]/[0.04] p-3.5 ${className ?? ""}`}>
      <div className="flex items-start gap-2">
        <ShieldCheck className="h-4 w-4 text-[#00162E] mt-0.5 shrink-0" />
        <p className="text-xs text-slate-600 leading-relaxed">
          We only earn when you get paid — a <span className="font-semibold text-[#00162E]">{percent}% platform fee</span>{" "}
      ...
      {hasAmount && (
        <div className="mt-3 space-y-1.5 border-t border-[#00162E]/10 pt-3">
          ...
          <div className="flex items-center justify-between border-t border-[#00162E]/10 pt-1.5">
